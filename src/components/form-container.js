  ...
  return (
    <section className="relative text-center text-black font-open-sans">
      <div className="flex justify-center items-center">
        <div className="my-2 mx-3 rounded-3xs bg-firebrick-100 text-center text-white py-1 px-1 sm:px-12 sm:text-5xl text-lgi uppercase inline-block font-bold leading-tight sm:leading-normal">
          Business Owners & Brands Above $30k Per Month
        </div>
      </div>
      <div className="text-13xl sm:text-22xl font-fugaz-one flex justify-center">
        <h1 className="text-inherit font-normal sm:max-w-[983px] leading-none sm:leading-tight px-4">
      ...
      <div className="flex flex-col items-center gap-2 text-3xl">
        <b className="relative leading-[28.6px] inline-block sm:max-w-[983px] my-1">
          Ready to scale?
        </b>
